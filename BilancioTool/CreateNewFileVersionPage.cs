...
{
    public class CreateNewFileVersionPage : Page
    {
        public CreateNewFileVersionPage(ICmdWizard program, IIOWrapper ioWrapper)
        ...
        protected override void DisplayContent()
        {
            ...
            //var payees = transactionsV4.Select(_ => _.Payee).GroupBy(_ => _).Select(_ => new Payee()
            //{
            //    Id = 1,
            //    Name = _.Key
            //}).ToList();
            //using (ExcelPackage package = new ExcelPackage(new FileInfo(mastroPath)))
            //{
            //    PayeeTable tt = new PayeeTable("Payees");
            //    tt.BuildTable(package.Workbook, payees);
            //    package.Save();
            //}


            //var accouns = transactionsV4.Select(_ => _.Account).GroupBy(_ => _).Select(_ => new Account()
            //{
            //    Id = 1,
            //    Name = _.Key
            //}).ToList();
            ...
            //using (ExcelPackage package = new ExcelPackage(new FileInfo(mastroPath)))
            //{
            //    AccountTable tt = new AccountTable("Accounts");
            //    tt.BuildTable(package.Workbook, accouns);
            //    package.Save();
            //}
            ...
            //{
            //    TransactionsTable tt = new TransactionsTable("Trans");
            //    tt.BuildTable(package.Workbook, transactionsV4);
            //    package.Save();
            //}
