...
{
    public class PayeeTable : BaseTable<Payee>
    {
        public PayeeTable() : base("Payees", true, 2)
        {

        }

        public PayeeTable(string tableName) : base(tableName, true, 8)
        {

        }

        protected override void PopulateWorksheet(ExcelWorksheet workSheet, ExcelTable table, List<Payee> data)
        {
        ...
        protected override List<Payee> ReadAllRows(ExcelWorksheet workSheet, int firstRow, int totalRows)
        {
            List<Payee> data = new List<Payee>();
        ...
        public override void UpdateTable(ExcelWorkbook workBook, List<Payee> data)
        {
