...
{
    public sealed class GenerateReport : Page
    {
        public GenerateReport(ICmdWizard program, IIOWrapper ioWrapper)
            : base("Generating report", program, ioWrapper)
        {
        }
        ...
        protected override void DisplayContent()
        {
            ...
            if (!IOWrapper.GetConfirmation($"Confirm master user as '{masterUser.Username}'?"))
            {
